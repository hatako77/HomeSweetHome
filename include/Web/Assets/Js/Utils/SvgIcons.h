...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64">
  <g style="fill: none;stroke-miterlimit:10;stroke: #ffffff;stroke-width: 2;">
    <path d="m49.2 41.2c1.5-2.8 2.3-5.9 2.3-9.2 0-3.3-.8-6.5-2.3-9.2" style="&#10;"/>
    <path d="m14.8 22.8c-1.5 2.8-2.3 5.9-2.3 9.2 0 3.3.8 6.5 2.3 9.2"/>
    <path d="m55.2 44.8c2.1-3.8 3.3-8.2 3.3-12.8 0-4.7-1.2-9-3.3-12.8"/>
    <path d="M8.8,19.2C6.7,23,5.5,27.3,5.5,32  c0,4.7,1.2,9,3.3,12.8"/>
  </g>
  <g style="fill: white;">
    <path d="m33.2 17.9c1.9.2 3.6-1.3 3.7-3.2.1-1.9-1.3-3.6-3.2-3.7-1.9-.1-3.6 1.3-3.7 3.2-.1 1.9 1.3 3.6 3.2 3.7"/>
